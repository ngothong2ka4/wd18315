...
<head>
    ...
    <form action="{{ route('product.store') }}" method="POST">
        ...
        <input type="text" name="name" value="{{ $product->name }}" disabled> <br>
        <label for="">Price</label>
        <input type="number" name="price" value="{{ $product->price }}" disabled> <br>
        <label for="">View</label>
        <input type="number" name="view" value="{{ $product->view }}" disabled> <br>
